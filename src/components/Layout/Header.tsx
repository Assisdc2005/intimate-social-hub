...
export const Header = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
      {!user && (
        <div className="bg-[#050505] text-[#8B5CF6] font-semibold text-[10px] sm:text-xs md:text-sm tracking-wide overflow-hidden border-b border-[#8B5CF6]/20">
          <div className="relative w-full">
            <p className="guest-banner-text whitespace-nowrap py-2 sm:py-2.5 px-6 flex items-center gap-3">
              <span className="flex items-center gap-2">
                <span aria-hidden="true">😈</span>
                <span>CONTINUE EXPLORANDO… CONEXÕES REAIS COMEÇAM AQUI</span>
              </span>
              <span className="opacity-90">
                • 🔒 SEGURANÇA E PRIVACIDADE 100% GARANTIDAS!
              </span>
            </p>
          </div>
        </div>
      )}
      <header className="glass backdrop-blur-xl border-b border-primary/20 shadow-[var(--shadow-glass)]">
